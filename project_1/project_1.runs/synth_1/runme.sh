...
HD_PWD='C:/Users/Eternal/Desktop/QAQ/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log simply.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source simply.tcl
