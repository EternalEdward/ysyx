...
HD_PWD='C:/Users/Eternal/Desktop/QAQ/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log simply.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source simply.tcl -notrace
